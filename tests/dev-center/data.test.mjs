...
test('tampered original artifact is rejected before generation',()=>assert.throws(()=>planJournalData(root,{reader:p=>p==='experiments/pelican-bicycle.html'?Buffer.from('changed'):read(p)}),/Original experiment changed: pelican-bicycle/));
